...
function custom_posts_per_page( $query ) {
    if ( $query->is_main_query() && !is_admin() ) {
        $query->set( 'posts_per_page', 10 ); // Establecer la cantidad de publicaciones por página
    }
}
...
require get_template_directory() . '/includes/customizer-hp.php';

// add theme support

add_theme_support('category-templates');
